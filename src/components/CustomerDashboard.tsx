...
import { Sparkles, LogOut, Package, X, Check, ArrowRight, Edit3, MapPin, Loader2, Truck } from 'lucide-react';
...
const DoneIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" {...props}>
                    ...
                    {customer.orders.map((ord) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          {(ord as any).courier_status && (
                            <div className="flex items-center gap-1.5 text-[10px] font-bold text-purple-700 bg-purple-50 px-2.5 py-1 rounded-lg border border-purple-200/60 w-fit">
                              <Truck className="w-3 h-3 text-purple-600" />
                              <span>Status Operasional: {(ord as any).courier_status}</span>
                            </div>
                          )}
